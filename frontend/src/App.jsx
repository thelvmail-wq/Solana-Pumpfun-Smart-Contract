  ...
  return (
    <div style={{height:"100vh",background:C.bg,color:C.text,fontFamily:C.sans,display:"flex",flexDirection:"column",overflow:"hidden"}}>
      ...
      <nav style={{position:"sticky",top:0,zIndex:100,background:"rgba(13,12,11,0.92)",backdropFilter:"blur(24px)",WebkitBackdropFilter:"blur(24px)",borderBottom:`1px solid ${C.border}`,height:52,display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 20px",flexShrink:0}}>
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          <div style={{width:36,height:36,borderRadius:"50%",background:"linear-gradient(135deg, rgba(201,168,76,0.15), rgba(201,168,76,0.05))",border:"1px solid rgba(201,168,76,0.2)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,overflow:"hidden"}}><img src="data:image/png;base64," style={{width:28,height:28,objectFit:"contain",filter:"brightness(2) sepia(0.2) saturate(1.2) hue-rotate(15deg)",opacity:0.9}} alt="summit.moon"/></div>
          <span style={{fontSize:18,fontWeight:500,color:"rgba(250,246,239,0.85)",fontFamily:C.serif,letterSpacing:"-0.02em",fontStyle:"italic"}}>summit<span style={{fontStyle:"normal",color:C.gold,fontWeight:600}}>.</span>moon</span>
