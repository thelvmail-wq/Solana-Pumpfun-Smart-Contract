    ...
    <div style={{height:"100vh",maxHeight:"100vh",background:C.bg,color:C.text,fontFamily:C.sans,display:"flex",flexDirection:"column",overflow:"hidden",position:"fixed",inset:0,zIndex:50}}>
      ...
      <div style={{position:"sticky",top:0,zIndex:100,background:"rgba(0,0,0,0.9)",backdropFilter:"blur(30px)",borderBottom:`1px solid ${C.border}`,padding:"0 20px",height:52,display:"flex",alignItems:"center",gap:12,flexShrink:0}}>
        ...
        <div style={{flex:1,minWidth:0,display:"flex",alignItems:"center",gap:10}}>
          ...
          {t.sourceLocked&&<div style={{background:"linear-gradient(135deg,rgba(201,168,76,0.15),rgba(201,168,76,0.05))",border:`1px solid rgba(201,168,76,0.35)`,borderRadius:6,padding:"3px 10px",display:"flex",alignItems:"center",gap:5}}>
      ...
      <div className="tp-body">
        ...
        <div className="tp-sidebar">
          ...
          {/* Source lock banner — top of sidebar */}
          {t.sourceLocked&&(
...
export default function SummitMoon() {
  ...
  return (
    <div style={{height:"100vh",background:C.bg,color:C.text,fontFamily:C.sans,display:"flex",flexDirection:"column",overflow:"hidden"}}>
      <style>{FONT}</style>

      <nav style={{position:"sticky",top:0,zIndex:100,background:"rgba(13,12,11,0.92)",backdropFilter:"blur(24px)",WebkitBackdropFilter:"blur(24px)",borderBottom:`1px solid ${C.border}`,height:52,display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 20px",flexShrink:0}}>
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          <img src="data:image/png;base64," style={{width:42,height:42,borderRadius:"50%",objectFit:"cover",flexShrink:0,border:"2px solid rgba(201,168,76,0.35)",filter:"brightness(2.2) contrast(1.05) sepia(0.15)",background:"rgba(201,168,76,0.08)"}}/>
          <span style={{fontSize:22,fontWeight:500,color:"rgba(250,246,239,0.9)",fontFamily:C.serif,letterSpacing:"-0.02em",fontStyle:"italic"}}>summit<span style={{fontStyle:"normal",color:C.gold,fontWeight:600}}>.</span>moon</span>
          <div style={{width:6,height:6,borderRadius:"50%",background:C.green,animation:"pulse 3s infinite",boxShadow:`0 0 6px ${C.green}`}}/>
          <div style={{padding:"3px 8px",background:"rgba(245,158,11,0.12)",border:"1px solid rgba(245,158,11,0.25)",borderRadius:4}}><span style={{fontSize:10,fontWeight:700,color:"#f59e0b",letterSpacing:"0.06em",fontFamily:C.mono}}>DEVNET</span></div>
        </div>
      ...
      <div style={{background:C.surface,borderBottom:`1px solid ${C.border}`,padding:"0 16px",height:28,display:"flex",alignItems:"center",gap:16,fontSize:11,flexShrink:0,width:"100%",boxSizing:"border-box"}}>
        ...
        <span style={{color:C.textQuat,flexShrink:0}}>TOKENS</span>
        <span style={{color:C.text,fontWeight:600,fontFamily:C.mono,flexShrink:0}}>{tokens.filter(t=>t.hasPool!==false).length}</span>
        <span style={{color:C.border,flexShrink:0}}>│</span>
        <span style={{color:C.textQuat,flexShrink:0}}>AIRDROP/QTR</span>
        <span style={{color:C.gold,fontWeight:700,fontFamily:C.mono,flexShrink:0}}>{fmtVol((platformVol*FEE_AIRDROP)*90)}</span>
        <span style={{color:C.border,flexShrink:0}}>│</span>
        <span style={{color:C.textQuat,flexShrink:0}}>SLOTS</span>
        <span style={{color:slotData.open>5?C.green:C.red,fontWeight:600,fontFamily:C.mono,cursor:"pointer",flexShrink:0}} onClick={()=>setShowSlots(true)}>{slotData.open}/{slotData.cap}</span>
        <div style={{flex:1}}/>
        <div style={{display:"flex",alignItems:"center",gap:4,flexShrink:0}}>
          <div style={{width:5,height:5,borderRadius:"50%",background:C.green,animation:"pulse 2s infinite"}}/>
          <span style={{color:C.textQuat,fontSize:10}}>Live</span>
        </div>
      </div>
